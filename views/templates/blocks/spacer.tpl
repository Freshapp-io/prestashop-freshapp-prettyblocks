...
<div
  ...
  class="fa-spacer {$block.classes}{if $block.settings.default.container} container{/if}{if $block.settings.default.force_full_width} _force-full{/if}{if $spacer_class} {$spacer_class|escape:'html':'UTF-8'}{/if}"
