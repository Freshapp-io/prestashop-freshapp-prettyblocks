...
<style>
  .freshapp-button-block-{$btn_uid|escape:'html':'UTF-8'} {
  ...
  .freshapp-btn-{$btn_uid|escape:'html':'UTF-8'} {
  ...
  .freshapp-btn-{$btn_uid|escape:'html':'UTF-8'}:hover,
  .freshapp-btn-{$btn_uid|escape:'html':'UTF-8'}:focus {
...
<div
  class="freshapp-button-block freshapp-button-block-{$btn_uid|escape:'html':'UTF-8'} {$block.classes|escape:'html':'UTF-8'}{if $block.settings.default.container} container{/if}{if $block.settings.default.force_full_width} _force-full{/if}"
  {$block.styles|escape:'html':'UTF-8'}
>
  <a
    {if $btn_id}id="{$btn_id|escape:'html':'UTF-8'}"{/if}
    class="freshapp-btn freshapp-btn-{$btn_uid|escape:'html':'UTF-8'} freshapp-btn-size-{$btn_size|escape:'html':'UTF-8'}{if $btn_class} {$btn_class|escape:'html':'UTF-8'}{/if}"
